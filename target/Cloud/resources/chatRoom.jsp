...
<script>
    ...
    var socket_url = "ws://localhost:8080/Cloud/hello.do?activityid=22";
   ...
   $(function(){
      ...
      alert(socket_url)
       ...
       $("#send").click(function(){
           ...
           var msg = "{";
           var message = {state:'',activityId:'22',message:'',sendTo:'',data:'',username:''};
           if(""==content){
               alert("输入消息内容！");
               return;
           }
    ...
    //连接成功websocket服务器时执行
       function onOpen(evt) { 
           ...
           sendd({state:'join',activityId:'22',message:'',sendTo:'',data:'',username:''})
    } 
