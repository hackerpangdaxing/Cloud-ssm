...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="resources/easyui/css/style.css" type="text/css" media="screen" charset="utf-8" />
    </head>
    <body>
                ...
                <div class="body">
                    <div class="col w10 last bottomlast">
                       <form id="content_file" action="file" method="post" enctype="multipart/form-data">
                            ...
                            <input type="button" onclick="window.location.href='https://www.pangdaxing.cn/model/examModel.xlsx'" value="下载课件模板" class="label"/>
                            </p>
